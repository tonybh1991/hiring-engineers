...
Then I need to write the API python calls script, which will also be included in my submission. Here is as screenshot of the widgets I need to create for my dashboard.
